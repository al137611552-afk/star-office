import { fetchStatus, fetchYesterdayMemo, setOfficeState } from './core/api.js?v=step11a';
import { createGameConfig } from './scene/office-scene.js?v=step11a';
import { setupUI } from './ui/dom.js?v=step11a';
