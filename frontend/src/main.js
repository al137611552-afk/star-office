import { fetchStatus, fetchYesterdayMemo, setOfficeState } from './core/api.js?v=step8b';
import { createGameConfig } from './scene/office-scene.js?v=step8b';
import { setupUI } from './ui/dom.js?v=step8b';
